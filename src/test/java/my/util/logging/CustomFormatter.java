// Quelle: https://stackoverflow.com/questions/2710524/how-to-configure-my-own-formatter-in-java-logging-property-file
...
//    public static final String DATE_FORMAT = "yyyy-MM-dd HH:mm:ss.SSS Z";
    public static final String DATE_FORMAT = "yyyy-MM-dd HH:mm:ss.SSS"; // EUG ohne zone
    ...
    public CustomFormatter()
    {
        ...
        Format[] formatsByArgumentIndex = messageFormat.getFormatsByArgumentIndex(); // BUG!?
//        needsArg = new boolean[formatsByArgumentIndex.length]; // oder hier
