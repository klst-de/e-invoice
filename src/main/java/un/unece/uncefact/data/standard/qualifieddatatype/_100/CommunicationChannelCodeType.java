 ...
 *   &lt;simpleContent&gt;
 *     &lt;extension base="&lt;urn:un:unece:uncefact:data:standard:QualifiedDataType:100&gt;CommunicationChannelCodeContentType"&gt;
 *       &lt;attribute name="listID" type="{http://www.w3.org/2001/XMLSchema}token" fixed="3155_CommunicationChannelCode" /&gt;
 *       &lt;attribute name="listAgencyID" type="{urn:un:unece:uncefact:data:standard:QualifiedDataType:100}CommunicationChannelCodeListAgencyIDContentType" fixed="6" /&gt;
...
@XmlType(name = "CommunicationChannelCodeType", propOrder = {
    "value"
})
public class CommunicationChannelCodeType {
    ...
    public String getListID() {
        if (listID == null) {
            return "3155_CommunicationChannelCode";
        } else {
            return listID;
        }
    }
