...
/**
 * <p>Java-Klasse für AutomaticDataCaptureMethodCodeType complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="AutomaticDataCaptureMethodCodeType">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;urn:un:unece:uncefact:data:standard:QualifiedDataType:100>AutomaticDataCaptureMethodCodeContentType">
 *       &lt;attribute name="listID" type="{http://www.w3.org/2001/XMLSchema}token" fixed="7233_AutomaticDataCaptureMethodCode" />
 *       &lt;attribute name="listAgencyID" type="{urn:un:unece:uncefact:data:standard:QualifiedDataType:100}AutomaticDataCaptureMethodCodeListAgencyIDContentType" fixed="6" />
...
@XmlType(name = "AutomaticDataCaptureMethodCodeType", propOrder = {
    "value"
})
public class AutomaticDataCaptureMethodCodeType {
    ...
    public String getListID() {
        if (listID == null) {
            return "7233_AutomaticDataCaptureMethodCode";
        } else {
            return listID;
        }
    }
