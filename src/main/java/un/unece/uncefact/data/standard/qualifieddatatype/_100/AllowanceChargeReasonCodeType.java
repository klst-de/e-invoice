...
/**
 * <p>Java-Klasse für AllowanceChargeReasonCodeType complex type.
 * 
 ...
 *       &lt;attribute name="listID" type="{http://www.w3.org/2001/XMLSchema}token" fixed="4465_AllowanceChargeReasonCode" /&gt;
 *       &lt;attribute name="listAgencyID" type="{urn:un:unece:uncefact:data:standard:QualifiedDataType:100}AllowanceChargeReasonCodeListAgencyIDContentType" fixed="6" /&gt;
...
public class AllowanceChargeReasonCodeType {
    ...
    public String getListID() {
        if (listID == null) {
            return "4465_AllowanceChargeReasonCode";
        } else {
            return listID;
        }
    }
