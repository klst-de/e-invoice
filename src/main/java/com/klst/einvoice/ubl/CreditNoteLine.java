...
public class CreditNoteLine extends CreditNoteLineType implements CoreInvoiceLine {
	...
	public CreditNoteLine(CreditNoteLineType line) {
		...
		init( line.getID().getValue()
			, new Quantity(line.getCreditedQuantity().getUnitCode(), line.getCreditedQuantity().getValue())
...
//		line.getInvoicePeriod() // List TODO
	 ...
	 */
	public CreditNoteLine(String id, Quantity quantity, Amount totalAmount, UnitPriceAmount priceAmount, String itemName
	...
	public Quantity getQuantity() {
		CreditedQuantityType quantity = super.getCreditedQuantity();
